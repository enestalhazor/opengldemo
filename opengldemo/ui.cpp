...
UI::UI(std::vector<Vertex>& vertices, std::vector<unsigned int> indices, std::vector<Texture>& textures, std::string shadername) : m_Mesh(vertices, indices, textures), m_Shader(shadername.c_str(), false)
{
