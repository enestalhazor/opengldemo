...
Light::Light(glm::vec3 ambient, glm::vec3 diffuse, glm::vec3 specular, glm::vec3 pos):
Entity(pos), m_CubeMap(SHADOW_WIDTH, SHADOW_HEIGHT, 0.5f, 25.0f), m_Ambient(ambient), m_Diffuse(diffuse), m_Specular(specular), m_Pos(pos)
{
